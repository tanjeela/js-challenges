...
// The function inside of reduce takes in two values.
// (previousVal, currentVal)
// curly brackets imply a multiline function so you need to specify what is the return of your function

/**
//  * Can turn a string with split("")
...
// Clean your data before you process it
// Make everything lowercase
// Arrange alphabetically 
// sort() function
// We don't need to write a sorting function => Does the actual reordering of the array
// We need a comparison function => compares two items of the array, to determine which one is bigger than the other
// Rather than true or false
// A comparison function actually returns 3 values, <0 =0
// can only call .toLowerCase on a single string
// Info still relevant but sort works
...
// A comparison function actually returns 3 values
// 0 a is before b
// =0 they are equal
// >0 b is before a 
  return;
