...
export const celsiusToFahrenheit = (tempInCelsius) => {
  const CelsiusToFahrenheitTemp = (tempInCelsius*9)/5 + 32;
  const CelsiusAndFahrenheitString = tempInCelsius +  " degrees celsius is " + CelsiusToFahrenheitTemp + " degrees fahrenheit"
  return CelsiusAndFahrenheitString;
};
...
const snickersToEat = maxAge - age;
const snickersLeftToConsume = snickersPerYear * snickersToEat
return snickersLeftToConsume;
};
...
const areaOfCircleToFixedDecimal = areaOfCircle.toFixed(2);
return parseFloat(areaOfCircleToFixedDecimal);
};
